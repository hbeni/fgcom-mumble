...
TEST_F(LineOfSightTest, EarthCurvatureEffects) {
    // Test earth curvature effects on LOS using ITU-R P.526-14
    double distance_km = tx_coord.calculateDistance(rx_coord);
    
    // Use ITU-R P.526-14 line of sight distance calculation
    double los_distance = FGCom_PropagationPhysics::calculateLineOfSightDistance(tx_coord.altitude, rx_coord.altitude);
