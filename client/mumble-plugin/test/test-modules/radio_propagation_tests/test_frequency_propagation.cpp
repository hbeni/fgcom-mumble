...
TEST_F(FrequencyPropagationTest, VHFPropagation) {
    ...
    // Test VHF atmospheric absorption using ITU-R P.676-11
    double atmospheric_absorption_db = FGCom_PropagationPhysics::calculateAtmosphericAbsorption(
...
TEST_F(FrequencyPropagationTest, UHFPropagation) {
    ...
    // Test UHF atmospheric absorption using ITU-R P.676-11
    double atmospheric_absorption_db = FGCom_PropagationPhysics::calculateAtmosphericAbsorption(
        frequency_mhz, distance_km, tx_coord.altitude, rx_coord.altitude);
