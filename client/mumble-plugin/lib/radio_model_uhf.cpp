...
void FGCom_radiowaveModel_UHF::loadMilitaryUHFPatterns() {
...
void FGCom_radiowaveModel_UHF::loadCivilianUHFPatterns() {
...
double FGCom_radiowaveModel_UHF::getUHFGain(const std::string& antenna_name, int altitude_m, 
...
std::string FGCom_radiowaveModel_UHF::getUHFAntennaName(const std::string& vehicle_type, double frequency_mhz) {
    if (!g_antenna_pattern_mapping) {
        g_antenna_pattern_mapping = std::make_unique<FGCom_AntennaPatternMapping>();
    }
...
float FGCom_radiowaveModel_UHF::calcPowerDistance(float power, double slantDist, double frequency_mhz, 
...
float FGCom_radiowaveModel_UHF::calcPowerDistance(float power, double slantDist) {
