    var client_%id%_popup = '<table class="map_popup"><tr><th>Callsign:</th><td>%callsign%</td></tr><tr><th>Frequencies:</th><td>%fequency%</td></tr><tr><th>Altitude:</th><td>%alt% m</td></tr></table>';
